...
if (_ie == true) {
  ...
  document.writeln('<APPLET WIDTH="800" HEIGHT="800" CODE="jfileupload.upload.client.MApplet.class" JAVA_CODEBASE="./" ARCHIVE="lib/jfileupload.jar,lib/httpimpl.jar,lib/chttpclient.jar,lib/clogging.jar,lib/s3upload.jar" WIDTH="250" HEIGHT="250" NAME="fileupload">');
}
