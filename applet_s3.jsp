...
<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="temp">
  <tr>
    ...
    - JFileUpload Applet S3Upload Extension<br>
    </strong></td>
    <tr >
		<p align ="center">How to upload: On the applet navigate to "File" then "Select Files" to open a local file browsers<br> select files to upload as normal, either single files or folders</p>
    </tr>
  </tr>
  <tr>
...
(Use S3 Menu to setup your Amazon S3 parameters)</span>        <br>
  ...
  <tr>
    <td align="center"><p><b><br>
      ...
      <p><b> This applet and it's code is from: JFileUpload Applet - JS3Upload</b><br>
...
<br>
 ...
 <br>
		<p align ="center">When done uploading, please click the "Back-to-FileArea" button to return to the FileArea and view your changes</p>
